...
local function list_update(w, buttons, label, data, objects)
  ...
  for i, o in ipairs(objects) do
    ...
    if cache then
      ...
      cbm = wibox.container.margin(cb, dpi(0), dpi(5), dpi(4), dpi(4)) -- 4, 8 ,12 ,12 -- close button
      cbm:buttons(
        gears.table.join(
          awful.button(
            {},
      ...
      ibm = wibox.container.margin(ib, dpi(8), dpi(8), dpi(3), dpi(3)) -- 12 is default top and bottom margin --app icon
